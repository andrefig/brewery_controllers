...
class ActorAPI(NotificationAPI):
    ...
    def actor_on(self, id, power=100):
        return self.api.switch_actor_on(int(id), power=power)

    @cbpi.try_catch(None)
    def actor_off(self, id):
        return self.api.switch_actor_off(int(id))
    ...
    #@cbpi.try_catch(None)
    #def actor_exib_on(self, id, power=100):
    #    #return self.api.switch_actor_exib(int(id))
    #    return self.api.switch_actor_exib_on(int(id), power=power)

    #@cbpi.try_catch(None)
    #def actor_exib_off(self, id):
    #    return self.api.switch_actor_exib_off(int(id))

    @cbpi.try_catch(None)
    def actor_exib(self, id):
        return self.api.switch_actor_exib(int(id))

    @cbpi.try_catch(None)
    def actor_read_status(self, id):
        return self.api.switch_actor_read_status(int(id))
